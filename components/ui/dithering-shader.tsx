...
function hexToRgba(hex: string): [number, number, number, number] {
  // Support #RRGGBBAA format
  const result8 = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(hex)
  if (result8) {
    return [
      Number.parseInt(result8[1], 16) / 255,
      Number.parseInt(result8[2], 16) / 255,
      Number.parseInt(result8[3], 16) / 255,
      Number.parseInt(result8[4], 16) / 255,
    ]
  }
